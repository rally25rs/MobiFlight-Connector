...
{
    public class TftButtonInputConfig : IXmlSerializable, ICloneable
    {
        ...
        public object Clone()
        {
            TftButtonInputConfig clone = new TftButtonInputConfig();
        ...
        {
            return obj != null && obj is TftButtonInputConfig && 
                (
                    (onPress == null && ((obj as TftButtonInputConfig).onPress == null)) || 
                    (onPress != null && onPress.Equals((obj as TftButtonInputConfig).onPress))
                ) &&
                (
                    (onRelease == null && ((obj as TftButtonInputConfig).onRelease == null)) ||
                    (onRelease != null && onRelease.Equals((obj as TftButtonInputConfig).onRelease))
                );
        }
    }
}
