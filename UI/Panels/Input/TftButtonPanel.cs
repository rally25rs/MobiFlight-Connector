...
{
    public partial class TftButtonPanel : UserControl
    {
        Dictionary<String, MobiFlightVariable> Variables = new Dictionary<String, MobiFlightVariable>();
        InputConfig.TftButtonInputConfig _config;

        public TftButtonPanel()
        {
            InitializeComponent();
        ...
        public void syncFromConfig(InputConfig.TftButtonInputConfig config)
        {
        ...
        public void ToConfig(InputConfig.TftButtonInputConfig config)
        {
